...
st.title("π")
st.write("π (pronounced paɪ) is a constant. It is the ratio of a circle's circumference to its diameter. It is approximately equal to 3.14. π day is on March 14th because March is the 3rd month of the year and the 14th because it corresponds to the 14 in 3.14. Ultimate π day was on March 14th, 1592, at 6:53 AM. The following picture shows the parts of a circle and how to find the circumference and area.")
st.image("circle.png")
